...
1 - Listar clientes 
2 - Crear clientes 
3 - Actualizar el estado de cliente

El front end se encuentra desarrollado en html, js y css con librerías tales como jquery y bootstrap. La arquitectura está basada en mvc.
